...
import argparse
from seq2seq_tf2.models.train_eval_test import train, test, evaluate

# from utils.log_utils import define_logger

NUM_SAMPLES = 82706 # 82706
...
def main():
    ...
    parser.add_argument("--beam_size", default=3,
                        ...
                        type=int)
    parser.add_argument("--vocab_size", default=69342, help="Vocabulary size", type=int) # 30000
    ...
    # others
    parser.add_argument("--steps_per_epoch", default=1300, help="max_train_steps", type=int) #1300
